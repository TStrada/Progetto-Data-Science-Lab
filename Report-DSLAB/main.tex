...
$modello$\\
\\
We created 4 different models, in order to forecast yearly and trimestral data for fishing and for football sales. The models p, q and d parameters are found by minimizing model AIC. We obtained the following models:
% \begin{description}
% 	\item[x] x
% 	\item[x] x
% 	\item[x] x
% \end{description}
\begin{itemize}
	\item Yearly fishing: ARIMA model (0,0,0)(0,0,0)
	\item Yearly football: ARIMA model (0,1,0)(0,0,0)
	\item Trimestral fishing: SARIMA model (0,2,0)(1,0,0)
	\item Trimestral football: SARIMA model (0,0,1)(1,1,0)
\end{itemize}
\subsection*{TBATS}
