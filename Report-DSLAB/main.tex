...
Nella figura sottostante possiamo osservare una formulazione matematica del modello in questione.

\begin{figure}
  \caption{Immagine da dispensa}
  \begin{center}
